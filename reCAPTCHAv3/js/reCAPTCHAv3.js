...
function getReCaptcha() {
    grecaptcha.ready(function () {
        ...
        grecaptcha.execute('6LfV_CohAAAAAAzRNZN2kjFMLjxofHytSQpSPatY', { action: 'homepage' }).then(function (token) {
            ...
            $.ajax({
                ...
                failure: function (response) {
                    document.getElementById("ContentPlaceHolder1_reCAPTCHAResponse").value = response.d;
                },
                error: function (err) {
                    document.getElementById("ContentPlaceHolder1_reCAPTCHAResponse").value = JSON.stringify(err, null, 2);
                }
            });
        });
    });
