<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Projects.aspx.cs" Inherits="reCAPTCHAv3.Projects" %>
        ...
        <div class="section-full p-t120 p-b90 site-bg-white">
         ...
         <%--       <div class="filter-wrap">
                ...
                <div class="masonry-wrap row clearfix d-flex justify-content-center flex-wrap">
                    ...
                    <div class="masonry-item cat-4 cat-3 col-xl-4 col-lg-4 col-md-6 m-b30">
                          ...
                          <div class="effect-hvr2-inner">
                                        ...
                                        <span class="project-new-category">Current Project</span>
                                      </div>  
                            </div>
                    <div class="masonry-item cat-4 cat-3 col-xl-4 col-lg-4 col-md-6 m-b30">
                                <div class="effect-hvr2">
                                    <div class="effect-sarah">
                                        <a href="45-Kensington-Dr.aspx">
                                      <img src="images/45Kensington-25.jpg">
                                      </a>
                                    </div>
                            ...
                            <div class="effect-hvr2-inner">
                                        <h4 class="wt-title"><a href="45-Kensington-Dr.aspx">45 Kensington Dr</a></h4>
                                        <span class="project-new-category">Completed Project</span>
                    ...
                    <div class="masonry-item cat-5 col-xl-4 col-lg-4 col-md-6 m-b30">
                         ...
                         <div class="effect-hvr2-inner">
                                        <h4 class="wt-title"><a href="389-Wescana.aspx">389 Wescana St</a></h4>
                                        <span class="project-new-category">Completed Project</span>
                    ...
                    <div class="masonry-item cat-5 col-xl-4 col-lg-4 col-md-6 m-b30">
                                <div class="effect-hvr2">
                                    <div class="effect-sarah">
                                        <a href="Headingley-Business-Centre.aspx">
                                      <img src="images/HBC-Cover.jpg" >
                         ...
                         <div class="effect-hvr2-inner">
                                        <h4 class="wt-title"><a href="Headingley-Business-Centre.aspx">Headingley Business Centre</a></h4>
                                        <span class="project-new-category">Upcoming Project</span>
                      ...
                      <div class="masonry-item cat-5 col-xl-4 col-lg-4 col-md-6 m-b30">
                        <div class="effect-hvr2">
                            <div class="effect-sarah">
                                <a href="#">
                                    <img src="images/KingCity-cover.jpg" alt="King City, ON">
                                </a>
                            </div>
                        ...
                        <div class="effect-hvr2-inner">
                            <h4 class="wt-title"><a>King City, ON</a></h4>
